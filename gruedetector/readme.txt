...
The Grue Detector example demonstrates how to use the QtSensors module to calculate
the chance of being eaten by a grue in a dark environment.

You will learn how to:
- Use the QLightSensor class to read values from the hardware light sensor
